...
<form class="layui-form" action="" style="padding: 10px">
    ...
    <div class="layui-form-item" id="type">
        <div class="layui-inline">
            ...
            <button type="button" class="layui-btn layui-btn-normal" onclick="addtype(this)">增加类型</button>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="month" lay-verify="required|number" autocomplete="off" class="layui-input" placeholder="以月为单位">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="price" lay-verify="required|number" autocomplete="off" class="layui-input" placeholder="请输入价格">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <input type="text" name="remark" autocomplete="off" class="layui-input" placeholder="请输入备注(可选)">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(formDemo)', function(data){
            $.post('/admin/plan/add',data.field,function (dd) {
                if(dd.code == 0){
