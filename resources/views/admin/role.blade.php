                                ...
                                <div class="table-list">
                                    <div class="a-top mb10 clearfix">
                                        ...
                                        <div class="fr clearfix how-many">
                                            <button type="button" class="layui-btn layui-btn-normal" onclick="add()">添加管理员</button>
...
<script type="text/html" id="bar">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">撤销权限</a>
</script>
    ...
    $('#seach').click(function () {
        ...
        if (keyword.val()){
            layui.use('table', function() {
                var table = layui.table;
                table.reload('plan', {
                    url: '/admin/getrole?key='+keyword.val()
                });
            });
        } else {
            keyword.focus();
