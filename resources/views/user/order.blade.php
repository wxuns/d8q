...
<div class="user-center-wrap">
    <div class="container">
        <!--面包屑导航-->
        <div class="crumbs"><a href="#">个人中心</a><span>/</span>我的订单</div>
        <!--/面包屑导航-->
                            ...
                            <div class="table-list-wrap">
                                <div class="table-list">
                                    <div class="balance-recharge">
                                        ...
                                        <p>账户余额可以用来购买平台的分发次数、企业签名和封装APP等服务。余额账户的钱不支持提现。</p>
                                        <a href="/balance/price" class="ms-btn ms-btn-primary w80 recharge-btn">充值</a>
                                    </div>
                                        ...
                                        <div class="table-wrap">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    @foreach($order as $o)
                                                    <tr>
                                                        <td class="">{{date('Y-m-d H:i:s',$o->time)}}</td>
                                                        <td class="">企业签名服务</td>
                                                        <td class="">{{$o->tradeno}}</td>
                                                        <td class="">
                                                            @if($o->paytype == 1)支付宝@elseif($o->paytype == 2)微信
                                                                @elseif($o->paytype == 3)余额@endif
                                                        </td>
                                                        <td class="">
                                                            {{$o->price}}                                                                                                                                    </td>
                                                        <td class="">{{$o->isclosed?'已完成':'处理中'}}</td>
                                                    </tr>
                                                        @endforeach
                                                </table>
                                            </div>
